...
class RigidObjectCollection(AssetBase):
    ...
    def reset(self, env_ids: torch.Tensor | None = None, object_ids: slice | torch.Tensor | None = None):
        ...
        self._external_force_torque_positions[env_ids[:, None], object_ids] = 0.0
    ...
    def write_data_to_sim(self):
        ...
        if self.has_external_wrench:
            self.root_physx_view.apply_forces_and_torques_at_position(
                ...
                position_data=self.reshape_data_to_view(self._external_force_torque_positions),
    ...
    def set_external_force_and_torque(
        ...
        Args:
            ...
            positions: External force and torque application positions in bodies' local frame.
                Shape is (len(env_ids), len(object_ids), 3). Defaults to None (origin of the body).
        ...
        if positions is not None:
            self._external_force_torque_positions[env_ids[:, None], object_ids] = positions
